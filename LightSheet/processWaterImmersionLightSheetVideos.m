...
%         folderNames={'Z:\RESULTS\2013-04-10_Beads200nm\2013-04-10 16_10_20.097_ApOneHalf'};
        folderNames={'F:\2015-12-07 Decon\2015-12-07 stepSize325nm.avi'};
...
%         folderNames={'H:\RESULTS\2013-11-27\'};
%         folderNames={'A:\RESULTS','E:\2013-11-29_zebrafish_3','E:\2013-11-29_zebrafish_4'};
    end
    if (nargin<2) 
%         reprocessData=false;
        reprocessData=true;
