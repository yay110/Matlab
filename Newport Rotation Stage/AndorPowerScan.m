% % Andor = Andor();
% % image = Andor.getImage;
% Andor.AcquisitionMode = 1;
% imageData = Andor.acquire;
% 
% imagesc(squeeze(imageData(1,:,:)));
% % colormap gray;
% 
% image = Andor.getImage;
% imagesc(image);
...
load('PowerCalibration800nm_20170801.mat');
figure;
...
folderName = 'D:\08-03 PowerScann in FLCIN';
...
p_var = p_min:0.05:0.3; %% Laser power measurement points
...
% Working directory
today = datevec(date);
workdir = sprintf('D:/LightSheet/%d-%02d-%02d/',today(1),today(2),today(3));
